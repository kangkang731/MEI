<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="recruitList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="岗位要求" align="center" prop="requirement" />
...
<script>
import { listRecruit, getRecruit, delRecruit, addRecruit, updateRecruit } from "@/api/mei/recruit"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除MEI-人才招聘信息编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('mei/recruit/export', {
        ...this.queryParams
